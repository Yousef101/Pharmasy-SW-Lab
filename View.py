...
class Ui_ViewProWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.clicked.connect(self.showProduct)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "View product"))
    ...
    def showProduct(self):
        if self.lineEdit.text() == "":
            ...
            return None
        showproduct = DBhelper()
        showproduct.searchProduct(int(self.lineEdit.text()))
