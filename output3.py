...
class CreateConnection():
    ...
    def addStudent(self,ProductID,ProductName,ProductQuantity,ProductPrice):
        try:
            self.c.execute("INSERT INTO Product (ProductID,ProductName,ProductQuantity,ProductPrice) VALUES (?,?,?,?)",(ProductID,ProductName,ProductQuantity,ProductPrice))
            self.conn.commit()
            self.c.close()
            self.conn.close()
...
class Ui_InsertProWindow(object):
    ...
    def addStudent(self):
        ...
        self.SendInputs.addStudent(self.ProductID,self.ProductName,self.ProductQuantity,self.ProductPrice)    
